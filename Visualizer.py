    ...
    for row in startingMatrix:
        ...
        for block in row:
            if block == 1:
                ...
                pygame.draw.rect(screen, white, (curX, curY, blocksize[0], blocksize[1]))
            elif block == "PATHWAY":
                # pygame.draw.rect(screen, black, (curX, curY, blocksize[0], blocksize[1]))
                pygame.draw.rect(screen, green, (curX, curY, blocksize[0], blocksize[1]))
            elif block == "BDS":
                # pygame.draw.rect(screen, black, (curX, curY, blocksize[0], blocksize[1]))
                pygame.draw.rect(screen, red, (curX, curY, blocksize[0], blocksize[1]))
            else:
             pygame.draw.rect(screen, black, (curX, curY, blocksize[0], blocksize[1]))
            curX += blocksize[0]
